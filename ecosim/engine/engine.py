...
import ecosim.entities.rng as _entity_rng_module
from ecosim.engine.engine_const import DAY_LENGTH, SIM_YEAR
from ecosim.engine.snapshot_view import EntityView, SimulationSnapshot
from ecosim.engine.snapshotter import Snapshotter
from ecosim.engine.species_registry import SpeciesRegistry
from ecosim.monitoring.death_log import DeathLogger
from ecosim.monitoring.logger import SimulationLogger
from ecosim.monitoring.report import SimulationReport
...
class SimulationEngine:
    def __init__(self, grid: Grid, seed: int | None = None):
        ...
        from ecosim.entities.animal import Individual
    ...
    def _tick_diseases(self) -> None:
        ...
        from ecosim.entities.disease import DISEASE_REGISTRY, try_infect
