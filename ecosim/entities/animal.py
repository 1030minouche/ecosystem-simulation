...
from ecosim.entities.activity import _is_pre_rest, _is_resting  # noqa: F401 — ré-export
from ecosim.entities.base import Entity
from ecosim.entities.death import mark_dead
from ecosim.entities.feeding import FeedingMixin
from ecosim.entities.genetics import Genome
from ecosim.entities.movement import MovementMixin
from ecosim.entities.reproduction import ReproductionMixin
...
class Individual(MovementMixin, FeedingMixin, ReproductionMixin, Entity):
    ...
    def tick(self, grid, all_plants, all_individuals, time_of_day: float = 0.5,
        ...
        if self.disease_states:
            from ecosim.entities.disease import DISEASE_REGISTRY
