...
def _reports_dir() -> pathlib.Path:
    """reports/ vit dans le cwd (où l'utilisateur lance ecosim), pas dans le paquet."""
    return pathlib.Path.cwd() / "reports"
...
class SimulationReport:
    ...
    def generate(self, tick: int, plants: list, individuals: list,
        ...
        base     = str(reports_dir / f"rapport_{self.start_time.strftime('%Y%m%d_%H%M%S')}")
        filename = base + ".json"
