...
class SimulationManager:
    ...
    def _run(self, config: dict) -> None:
        ...
        from ecosim.engine.headless import load_diseases
        from ecosim.engine.recording.recorder import Recorder
        from ecosim.engine.runner import EngineRunner
        from ecosim.web.renderer import (
            RENDER_H,
            RENDER_W,
            render_engine_frame,
            terrain_arr_from_grid,
        )
        from ecosim.world.grid import Grid
        from ecosim.world.terrain import generate_terrain
        _diseases_dir = _Path(__file__).parent.parent / "data" / "diseases"
        ...
        try:
            ...
            if config.get("mode") == "infect" and config.get("db_path"):
                ...
                from ecosim.engine.recording.resume import load_engine_from_db_at_tick
                from ecosim.entities.disease import DISEASE_REGISTRY, DiseaseState
                ...
                from ecosim.engine.recording.resume import load_engine_from_db
                ...
                from ecosim.engine.recording.manifest import build_manifest, write_manifest
